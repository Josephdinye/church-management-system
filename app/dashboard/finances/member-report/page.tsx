    ...
    <>
      ...
      <div className="print-container" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px', borderBottom: '4px solid #1e3a8a', paddingBottom: '25px' }}>
          <h1 style={{ fontSize: 'clamp(28px, 6vw, 36px)', margin: '0', color: '#1e3a8a' }}>{churchConfig.name}</h1>
          <p style={{ margin: '8px 0', color: '#334155' }}>{churchConfig.address}</p>
        </div>

        <h2 style={{ textAlign: 'center', marginBottom: '30px', color: '#1e3a8a', fontSize: 'clamp(24px, 5vw, 32px)' }}>MEMBER FINANCIAL HISTORY</h2>

        {selectedMember && (
          <div style={{ marginBottom: '30px', textAlign: 'center' }}>
            <p style={{ fontSize: 'clamp(20px, 5vw, 22px)', fontWeight: '600' }}>{selectedMember.fullName}</p>
        ...
        <div style={{ marginTop: '40px', textAlign: 'right', fontWeight: '600', fontSize: 'clamp(16px, 4vw, 18px)' }}>
